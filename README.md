# Trabalho da disciplina de orientação a objetos com PHP.
...
Com base no caso acima, identifique as classes com suas propriedades e métodos. Apresente a lista na forma de um mapa mental, liste o máximo de classes, propriedades e métodos que conseguir.

## Como rodar o projeto?

Para poder testar as classes desenvolvidas neste trabalho siga o passo a passo: 
1. Rodar compose dumpautoload;
2. Testar as classes. Na pasta manual é possivel encontrar alguns arquivos que fiz durante o trabalho, se preferir pode usá-los para realizar os testes;
3. Toda a estrutura do projeto está na pasta src onde é possivel encontrar diversas classes;
4. O projeto implementa os quatro pilares da orientação a objetos e até alguns principios de SOLID.